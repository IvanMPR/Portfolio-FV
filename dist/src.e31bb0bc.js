...
var iconsContainer = document.querySelector('.nav-right__theme-toggler');
var darkIcon = document.querySelector('.uil-moon');
var lightIcon = document.querySelector('.uil-sun');
...
var progressBarFiller = document.querySelector('.scroll-bar');
...
var sectionObserver = new IntersectionObserver(stickyNav, {
  root: null,
  threshold: 0,
  thresholdMargin: 100
});
